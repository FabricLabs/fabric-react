(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory(require('react'), require('graphviz-react'), require('crypto'), require('events'), require('semantic-ui-react'), require('buffer')) :
  typeof define === 'function' && define.amd ? define(['react', 'graphviz-react', 'crypto', 'events', 'semantic-ui-react', 'buffer'], factory) :
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, global.FabricReact = factory(global.React$1, global.graphvizReact, global.crypto, global.events, global.semanticUiReact, global.buffer));
})(this, (function (React$1, graphvizReact, crypto, events, semanticUiReact, buffer) { 'use strict';
